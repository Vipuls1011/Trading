...
try:
    historicParam = {
        "exchange": "NSE",
        "symboltoken": "99926009",  # Ensure this token is for the correct symbol
        "interval": "FIVE_MINUTE",
        "fromdate": "2025-05-01 09:15",  # Start from 1st October 2024
    ...
    if 'data' in candeldata:
        ...
        excel_filename = r"D:\VSCode\AngelOne\BN_Historical.xlsx"
